...
class ADII2CExpander {
  public:
    ...
    void
    configure(I2CExpanderOutputEN output_en = I2CExpanderOutputEN::DEFAULT);
...
class Adcam {
  public:
    ...
    bytes_to_uint16_array_be(const std::vector<uint8_t> &data);
    ...
    void
    configure_converter(std::shared_ptr<hololink::csi::CsiConverter> converter);
    ...
    uint16_t
    get_imager_type(); // detected imager type (ADSD3100 = 1 , ADTF3066 = 2)
